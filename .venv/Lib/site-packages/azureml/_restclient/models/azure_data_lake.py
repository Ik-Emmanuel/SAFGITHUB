...
class AzureDataLake(Model):
    ...
    def __init__(self, store_name=None, client_id=None, tenant_id=None, is_cert_auth=None, certificate=None, thumbprint=None, client_secret=None, authority_url=None, resource_uri=None, subscription_id=None, resource_group=None):
