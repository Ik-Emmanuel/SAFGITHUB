...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import AutoMLInternal, \
    ConflictingValueForArguments, FeatureUnsupportedForIncompatibleArguments, InvalidArgumentType, \
    InvalidOperationOnRunState, OnnxNotEnabled, OnnxSplitsNotEnabled, NoMetricsData, ModelMissing
...
class AutoMLRun(Run):
    ...
    def get_output(self,
        ...
        with log_server.new_log_context():
            ...
            with logging_utilities.log_activity(
                ...
                curr_run, model_name = self._get_child_run(
                    iteration=iteration,
                    metric=metric,
    ...
    def get_best_child(self,
        ...
        """
        run, _ = self._get_child_run(metric=metric,
