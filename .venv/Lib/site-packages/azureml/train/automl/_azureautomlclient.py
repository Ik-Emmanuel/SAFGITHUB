...
from azureml._common._error_definition.user_error import ConnectionFailure, NotFound
...
from azureml._restclient.models import LocalHistoryPayload, MiroProxyInputDto
...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import (
    InvalidArgumentWithSupportedValues, InvalidArgumentType, SnapshotLimitExceeded)
from azureml.automl.core.shared._diagnostics.contract import Contract
from azureml.automl.core.shared.constants import TelemetryConstants
from azureml.automl.core.shared.exceptions import AutoMLException, OptionalDependencyMissingException, UserException
...
class AzureAutoMLClient:
        ...
        try:
            if self.automl_settings.spark_context:
                ...
                if not self.automl_settings._ignore_package_version_incompatibilities:
                    runtime_client._check_package_compatibilities(is_managed_run=_script_run is not None)
                ...
                try:
                    ...
                    raise UserException._with_error(
                        AzureMLError.create(ConnectionFailure, target="_fit_local", resource_name=str(ce))
                    ) from ce
            else:
        ...
        try:
            ...
            if ((str(SNAPSHOT_MAX_SIZE_BYTES / ONE_MB) in se.message) or (str(SNAPSHOT_MAX_FILES) in se.message)):
                ...
                raise SnapshotException._with_error(
                    AzureMLError.create(
                        SnapshotLimitExceeded, target=self.automl_settings.path,
    ...
    def _fit_remote_core(self, run_configuration, X=None, y=None, sample_weight=None, X_valid=None, y_valid=None,
        ...
        try:
            ...
            self._jasmine_client.post_remote_jasmine_snapshot_run(
                self.parent_run_id, json.dumps(definition), snapshot_id)
    ...
    def _get_task(self, previous_fit_outputs, is_sparse=None):
        """
