...
from azureml.automl.core.shared._diagnostics.automl_error_definitions import AutoMLInternal, InvalidArgumentType
...
class Validation:
    ...
    def validate_type(value: Any, name: str,
                      ...
                      reference_code: Optional[str] = None, log_safe: bool = False) -> None:
        """
        ...
        if not isinstance(value, expected_types):
            if log_safe:
                # We can also print the value in the logs
                logger.error("Argument validation failed. Expected {} ({}) of type {}, but is of type {}.".format(
