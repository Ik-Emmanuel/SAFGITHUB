...
from azureml._vendor.azure_cli_core.util import get_file_json, in_cloud_console, open_page_in_browser, \
    can_launch_browser
...
class Profile(object):
    ...
    def __init__(self, storage=None, auth_ctx_factory=None, use_global_creds_cache=True,
        ...
        from azureml._vendor.azure_cli_core.cloud import Cloud
...
class SubscriptionFinder(object):
    ...
    def find_through_interactive_flow(self, tenant, resource):
        ...
        # This line prints the device code, so we are using a print here so that a user sees it irrespective
        # of logger level settings.
        print(code['message'])
        sys.stdout.flush()
