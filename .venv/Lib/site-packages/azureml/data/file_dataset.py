    ...
    def mount(self, mount_point=None, **kwargs):
        ...
        try:
            ...
            raise UserErrorException('Mount is only supported on Unix or Unix-like operating systems and the '
                                     ...
                                     'remarks section of FileDataset.mount\'s documentation.')
        ...
        try:
            if not skip_validate and dataflow.has_invalid_source():
                raise UserErrorException('Cannot mount dataset. Source of the dataset is either not accessible '
