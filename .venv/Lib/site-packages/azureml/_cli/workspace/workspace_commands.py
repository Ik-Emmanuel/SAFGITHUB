...
def create_workspace(workspace_name, resource_group_name=None, location=None,
                     ...
                     create_resource_group=None, exist_ok=False, sku='basic', pe_name=None, pe_vnet_name=None,
    ...
    workspace_object = Workspace.create(workspace_name, auth=auth, subscription_id=default_subscription_id,
                                        ...
                                        exist_ok=exist_ok, sku=sku, private_endpoint_config=private_endpoint_config,
...
SKU = argument.Argument("sku", "--sku", "", help="Sku of the workspace, upgrade only", required=False)
...
def update_workspace(
    ...
    return workspace.update(friendly_name=friendly_name, description=description, tags=tags,
                            image_build_compute=image_build_compute, sku=sku)
